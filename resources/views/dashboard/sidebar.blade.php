<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ Request::segment(1) == 'clients' ? 'active' : '' }} ">
            <a href="{{ route('clients.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-user"></i>
                <div data-i18n="Text Divider">Clients</div>
            </a>
        </li>



<li class="menu-item {{ Request::segment(1) == 'projects' ? 'active' : '' }} ">
            <a href="{{ route('projects.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-package"></i>
                <div data-i18n="Text Divider">projects</div>
            </a>
        </li>
        ...
        <li class="menu-item {{ Request::segment(1) == 'tasks' ? 'active' : '' }} ">
            <a href="{{ route('tasks.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-poll"></i>
                <div data-i18n="Text Divider">Tasks</div>
            </a>
        </li>
